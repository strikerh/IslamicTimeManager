...
public class TaskItemDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.p10_activity_taskitem_detail);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Snackbar.make(view, "Replace with youjhgjhgjhgjhg jdsf sg djf gr own detail action", Snackbar.LENGTH_LONG)
        ...
        if (savedInstanceState == null) {
            ...
            arguments.putString(TaskItemDetailFragment.ARG_ITEM_ID,
                    getIntent().getStringExtra(TaskItemDetailFragment.ARG_ITEM_ID));
