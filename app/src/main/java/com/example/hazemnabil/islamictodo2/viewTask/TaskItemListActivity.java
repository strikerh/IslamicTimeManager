...
/**
 * An activity representing a list of TaskItems. This activity
...
public class TaskItemListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.p10_activity_taskitem_list);
    ...
    public class SimpleItemRecyclerViewAdapter
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.p10_taskitem_list_content, parent, false);
            ...
            holder.mView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (mTwoPane) {
                        ...
                        arguments.putString(TaskItemDetailFragment.ARG_ITEM_ID, holder.mItem.id);
                        ...
                        intent.putExtra(TaskItemDetailFragment.ARG_ITEM_ID, holder.mItem.id);
