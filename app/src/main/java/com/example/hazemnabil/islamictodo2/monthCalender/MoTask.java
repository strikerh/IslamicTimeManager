...
public class MoTask{
    ...
    public int fillThisTask(Cursor taskCursor) {
       ...
       // DatabaseUtils.cursorRowToContentValues(taskCursor, taskContent);
        ...
        if (taskCursor.getString(taskCursor.getColumnIndex("d_day")) != null)           this.date_day     =  taskCursor.getInt(taskCursor.getColumnIndex("d_day"));
        if (taskCursor.getString(taskCursor.getColumnIndex("d_month")) != null)         this.date_month     =   taskCursor.getInt(taskCursor.getColumnIndex("d_month"));
        if (taskCursor.getString(taskCursor.getColumnIndex("d_year")) != null)          this.date_year     =  taskCursor.getInt(taskCursor.getColumnIndex("d_year"));
